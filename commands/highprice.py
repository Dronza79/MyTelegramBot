...
from api.handler_request_api_hotels import display_result
from api.handler_step_poll import get_city, get_photos
...
@bot.callback_query_handler(func=lambda call: call.data in ['yes_hp', 'not_hp'])
def get_answer(call):
